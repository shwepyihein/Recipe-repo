...
export default function Home() {
  ...
  const handleDelete = async () => {
    await client.delete(`/recipes/${deleteData?.id}`).then((res) => {
      mutate('/recipes');
  ...
  return (
    <>
      <SlideOver type="create" open={open} setOpen={setOpen} />
      <SlideOver
      ...
      <div className="md:max-w-screen-lg py-10  px-10 mx-auto">
        <p className="lg:block hidden text-2xl font-bold">Recipes</p>
